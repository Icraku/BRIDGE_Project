...
image_path = "/home/ikutswa/data/BRIDGE/patient_documents/converted_images/17000006_NAR_2015_EEQsDZu_page_1.png"
...
def list_to_dict(pred_list):
    """
    Converts a list of strings like 'Key: Value' to a dictionary.
...
def run_all():
    ...
    for prompt_name, prompt_text in prompts.items():
        ...
        if isinstance(prediction, list):
            prediction = list_to_dict(prediction)
