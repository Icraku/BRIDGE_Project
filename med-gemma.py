...
image_path = (
    "/home/ikutswa/data/BRIDGE/patient_documents/Test_conversion/converted_images/5300014_NAR_428_page_1.png"
)
...
def run_all():
    ...
    # -------- Save full report --------
    with open("models/extraction_results.json", "w") as f:
